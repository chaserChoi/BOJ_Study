...
### 입력 
 ...
 <p>W pierwszym wierszu wejścia znajduje się liczba $N$, oznaczająca liczbę wierszy tekstu do analizy ($N ≤ 150$). W każdym z następujących $N$ znajduje się ciąg złożony z maksymalnie $200$ znaków spośród małych i wielkich liter alfabetu łacińskiego ('a'..'z', 'A'..'Z') oraz spacji.</p>
